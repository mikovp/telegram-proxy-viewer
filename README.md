...
- Для каждого прокси показывает статус: _ожидает проверки_, _подтверждён_ или _статус не подтверждён_ (best‑effort по HTTP/HTTPS, без жёсткого помечания «мёртвых»).
